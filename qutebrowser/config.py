...
# Type: ShellCommand
c.editor.command = ['kitty', '--title', 'qutebrowser-floating-url-edit', 'nvim', '-n', '+set laststatus=0 noshowmode', '+nnoremap <CR> :wq<CR>', '+inoremap <CR> <Esc>:wq<CR>', '+vnoremap <CR> <Esc>:wq<CR>', '{file}']
